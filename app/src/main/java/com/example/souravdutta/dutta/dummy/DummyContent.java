 ...
 */
package com.example.souravdutta.dutta.dummy;
...
public class DummyContent {
    ...
    public static class DummyItem {
        ...
        public DummyItem(String id, String content, GeoPoint location,
                         String text) {
            this.id = id;
    ...
    static {
        addItem(new DummyItem("1", "Brandenburger Tor", new GeoPoint(52.516,
                13.378), "This is the famous Brandenburger Tor"));
        addItem(new DummyItem("2", "Checkpoint Charlie", new GeoPoint(52.507,
                13.390), "This used to be the famous Checkpoint Charlie"));
        addItem(new DummyItem(
                "3",
                "Savigny Platz",
                new GeoPoint(52.505, 13.322),
